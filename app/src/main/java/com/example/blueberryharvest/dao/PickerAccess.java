...
public class PickerAccess {
    ...
    public void create() throws SQLException {
        ...
        String create = "create table if not exists picker (date text not null primary key, " +
    ...
    public Picker[] findAllBuckets(String date) throws SQLException {
        Database db = new Database();
        Connection connection = db.getConnection();
        ...
        Picker[] buckets = new Picker[size];
        int i = 0;
        while(results.next()) {
            buckets[i] = new Picker(results.getDouble(3), results.getString(2),
                    results.getString(1));
            i += 1;
        }
        results.close();
